...
admission_notices_converstion = [
    'Can you provide information about the admission process in the university?',
    "For general instructions about admission, check here: \
    ...
    'More Admission Notices',
    "Click here: <a href='systems/c/admissions/announcementsnotices.html'> \
        More Admission Notices </a>",
