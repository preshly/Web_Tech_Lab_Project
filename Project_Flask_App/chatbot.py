...
from college_convo import general_college_intents,professional_edu_institution_intents,general_edu_institution_intents,recognised_edu_institution_intents
...
class Nltk_Convo:
    ...
    def __init__(self) -> None:
        self.all_data = [hostel_intents, greetings_intents, academic_intents, migration_intents, transcripts_intents, contact_intents,email_intents,general_college_intents,general_edu_institution_intents,professional_edu_institution_intents,recognised_edu_institution_intents]
        self.words = []
        self.labels = []
        self.docs_x = []
        self.docs_y = []
