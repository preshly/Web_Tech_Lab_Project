...
apply_for_conversations = [
    'Examination query.',
    "Choose from the following. Apply for: \
    ...
    'Answer Book Photocopy',
    "Check this link: <a href='/systems/a/examinations/apply-for/answer-book-photocopies.html#afab'> \
        Apply for Aanswer Book Photocopies </a>",
    
    'Degree Certificate',
    "Check this link: <a href='/systems/a/examinations/apply-for/degree-certificate.html#1'> \
        Apply for Degree Certificate </a>",
    
    'Documents Authentication',
    "There are two ways, Online and Manual. Check this link: \
    ...
    'Duplicate Marksheets & Certificates',
    "Check this link: <a href='/systems/a/examinations/apply-for/duplicate-marksheets-certificates.html#dupct'> \
        Apply for Duplicate Marksheets & Certificates </a>",
    
    'Verification of Answer Book',
    "Check this link: \
...
convocation_conversations = [
    'Give information about convocation in the University',
    "Check this link: <a href='/systems/c/examinations/convocation.html'> Convocation </a>",
]
