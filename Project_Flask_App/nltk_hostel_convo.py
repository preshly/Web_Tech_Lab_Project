...
hostel_intents = {"intents": [
        {"tag": "hostel_details",
        "patterns": ["Provide hostel details", "Give hostel details", "hostel details", "details of hostel",
            "hostel detail", "hostel info", "hostel information", "provide hostel information", 
            "give info of hostel", "hostel"],
        "responses": ["Choose from the following options of hostel: \
            ...
            <br /> <button type='button' onClick='buttonAction(this)'> Warden's</button> \
        ...
        {"tag": "chief_wardens",
        "patterns": ["Chief Warden\'s", "Who are the chief wardens", "chief warden", "who are chief wardens",
            "wardens chief"],
        ...
        {"tag": "wardens",
        "patterns": ["Warden\'s", "who are the Warden\'s in University", "wardens", "give wardens details",
            "provide hostel wardens details", "hostel wardens", "wardens at university hostel"],
        ...
        {"tag": "hostel_facility",
        "patterns": ["Hostel Facilities", "facilities at university hostel", "hostel facilities", 
            "hostel facility", "what facilities hostel provides", "facility of hostel", ],
        "responses": ["Check here: <a href='/facilities/hostelsmess.html#faci' > Hostel Facilities </a>"]
        },

        {"tag": "hostel_admission",
        "patterns": ["Hostel Admission", "how to apply for hostel", "hostel admission details",
            "apply for hostel", "admission to hostel"],
        "responses": ["Check here: <a href='/facilities/hostelsmess.html#admission' > Hostel Admission </a>"]
        },

        {"tag": "hostel_fee",
        "patterns": ["Hostel Fee", "what is the hostel fees", "hostel fee", "fees of the hostel"],
